...
def main() -> None:
    ...
    if args.history_path is None and args.metrics_path is None:
        raise ValueError("Provide at least one of --history-path or --metrics-path.")
    ...
    curves_run_dir = args.curves_dir.expanduser().resolve() / resolved_run_name
